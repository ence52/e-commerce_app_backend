from app.api.v1 import cart, category, product, user,favorites
...
FavoriteModel.metadata.create_all(bind=engine)
...
app.include_router(favorites.router, prefix="/users/favorites", tags=["Favorites"])
